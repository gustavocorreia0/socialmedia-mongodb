...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, date.parse("13/03/2024"), "Avanço na Aula", "Hoje eu aprendi muitas coisas!", u1);
		Post p2 = new Post(null, date.parse("11/03/2024"), "Janta com marido", "Hoje fiz uma janta especial ao meu marido!", u2);
		Post p3 = new Post(null, date.parse("12/03/2024"), "Quebrei um Vaso", "Consegui quebrar o vaso da mamãe...", u4);
